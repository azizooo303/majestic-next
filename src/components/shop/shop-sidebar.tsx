  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={resetAll}
          className="text-xs text-[#484848] hover:text-[#0c0c0c] transition-colors underline underline-offset-2"
        >
              ...
              return (
                <li key={cat.slug}>
                  <label className="flex items-center gap-2.5 cursor-pointer group/item">
                    ...
                    />
                    <span
                      className={`text-sm transition-colors group-hover/item:text-[#0c0c0c] ${
                        isActive ? "text-[#0c0c0c] font-semibold" : "text-[#484848]"
                      }`}
                    >
                      {isAr ? cat.ar : cat.en}
                    </span>
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full border border-[rgba(0,0,0,0.21)] rounded-sm px-2 py-1.5 text-xs
                  text-[#0c0c0c] placeholder:text-[#484848] focus:outline-none focus:border-[#0c0c0c] bg-white"
              />
            </div>
