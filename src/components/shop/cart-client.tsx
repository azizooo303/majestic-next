  ...
  return (
    <div className="flex items-center border border-[rgba(0,0,0,0.21)] rounded-sm">
      <button
        ...
        className="w-8 h-8 flex items-center justify-center text-[#484848] hover:text-[#0c0c0c] hover:bg-[#fafafa] transition-colors text-lg leading-none select-none"
      >
        −
      </button>
      <span className="w-8 text-center text-sm font-semibold text-[#0c0c0c] select-none">
        {value}
      </span>
      <button
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            >
                    ...
                    <div className="flex flex-1 min-w-0 flex-col gap-1.5">
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          <p className="font-bold text-[#0c0c0c] text-sm leading-snug">
              ...
              <div className="mt-4">
                <Link
                  href="/shop"
                  className="text-sm text-[#484848] hover:text-[#0c0c0c] border-b border-[#484848] pb-0.5 transition-colors"
                >
                  {isAr ? "متابعة التسوق" : "Continue Shopping"}
                </Link>
              </div>
            ...
            >
              <div className="border border-[rgba(0,0,0,0.21)] rounded-sm p-6 bg-white">
                ...
                <button className="btn-press w-full mt-3 border border-[rgba(0,0,0,0.21)] text-[#0c0c0c] py-3.5 font-semibold text-sm rounded-sm hover:bg-[#fafafa] transition-colors">
