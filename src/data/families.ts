...
export const DESK_FAMILIES: DeskFamily[] = [
  ...
  },
  {
    ...
    nameEn: "Nepton Desk",
    nameAr: "مكتب نبتون",
    tagline: {en: "Metal-leg system — 11 base designs", ar: "نظام أرجل معدنية — 11 تصميماً أساسياً"},
    configs: ["Executive", "Operator", "Manager", "Manager L", "L-Shape Full Storage", "L-Shape Return Pedestal", "Conference", "Meeting", "Straight", "Side Console", "Coffee Table", "Custom (Contact Us)"],
    hasGlb: true,
    priority: 14,
    status: "live",
