...
export const DESK_FAMILIES: DeskFamily[] = [
  ...
  },
  {
    ...
    configs: ["Operator","Storage Credenza","Tall Credenza","Coffee Table","Custom (Contact Us)"],
    hasGlb: true,
  ...
  },
  {
    ...
    configs: ["L-Shape","Custom (Contact Us)"],
    hasGlb: true,
  ...
  },
  {
    ...
    configs: ["Operator","Custom (Contact Us)"],
    hasGlb: true,
    priority: 12,
    status: "live",
  },
  {
    ...
    nameEn: "Diamond Desk",
    nameAr: "مكتب دايموند",
    configs: ["Operator","Manager","Custom (Contact Us)"],
    hasGlb: true,
    priority: 13,
    status: "live",
  },
  ...
  },
  {
    ...
    configs: ["Operator","Height-Adjustable","Custom (Contact Us)"],
    hasGlb: true,
    priority: 16,
    status: "live",
  },
