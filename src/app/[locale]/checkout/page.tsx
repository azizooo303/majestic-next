...
function PaymentTab({ method, active, onClick, children }: PaymentTabProps) {
  return (
    <button
      type="button"
      onClick={onClick}
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Card fields — shown only when card is active */}
...
export default function CheckoutPage() {
  ...
  // Generate order number once per mount
  ...
  return (
    <main
      id="main-content"
      className="bg-white min-h-screen py-10 md:py-14"
    >
      <div className="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        {/* Confirmation: full-width, no sidebar */}
        {isConfirmation ? (
          <StepConfirmation
            email={form.email}
